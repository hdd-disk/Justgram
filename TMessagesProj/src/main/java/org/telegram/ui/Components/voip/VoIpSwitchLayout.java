...
public class VoIpSwitchLayout extends FrameLayout {
    ...
    private void attachNewButton(int rawRes, int size, boolean isSelected, Type type) {
        ...
        if (rawRes == R.raw.camera_flip2) {
            newVoIpButtonView.singleIcon = new TLottieDrawable(rawRes, "" + rawRes, size, size, true, null);
            newVoIpButtonView.singleIcon.setMasterParent(newVoIpButtonView);
        } else {
            newVoIpButtonView.unSelectedIcon = new TLottieDrawable(rawRes, "" + rawRes, size, size, true, null);
            newVoIpButtonView.selectedIcon = new TLottieDrawable(rawRes, "" + rawRes, size, size, true, null);
        ...
        switch (newType) {
            case MICRO:
                if (this.type != Type.MICRO) {
                    voIpButtonView.unSelectedIcon = new TLottieDrawable(R.raw.call_mute, "" + R.raw.call_mute, size, size, true, null);
                    voIpButtonView.selectedIcon = new TLottieDrawable(R.raw.call_mute, "" + R.raw.call_mute, size, size, true, null);
            ...
            case VIDEO:
                ...
                if (this.type != Type.VIDEO) {
                    voIpButtonView.unSelectedIcon = new TLottieDrawable(R.raw.video_stop, "" + R.raw.video_stop, size, size, true, null);
                    voIpButtonView.selectedIcon = new TLottieDrawable(R.raw.video_stop, "" + R.raw.video_stop, size, size, true, null);
                    voIpButtonView.selectedIcon.setColorFilter(new PorterDuffColorFilter(Color.BLACK, PorterDuff.Mode.MULTIPLY));
                    voIpButtonView.selectedIcon.setMasterParent(voIpButtonView);
                }
                break;
            case CAMERA:
                if (this.type == Type.SPEAKER || this.type == Type.BLUETOOTH) {
                    ...
                    voIpButtonView.singleIcon = new TLottieDrawable(R.raw.camera_flip2, "" + R.raw.camera_flip2, size, size, true, null);
            ...
            case SPEAKER:
                if (this.type == Type.BLUETOOTH) {
                    ...
                    TLottieDrawable icon = isSelected ? voIpButtonView.selectedIcon : voIpButtonView.unSelectedIcon;
    ...
    private void attachSpeakerToBt(int size) {
        voIpButtonView.unSelectedIcon = new TLottieDrawable(R.raw.speaker_to_bt, "" + R.raw.speaker_to_bt, size, size, true, null);
        voIpButtonView.selectedIcon = new TLottieDrawable(R.raw.speaker_to_bt, "" + R.raw.speaker_to_bt, size, size, true, null);
        voIpButtonView.selectedIcon.setColorFilter(new PorterDuffColorFilter(Color.BLACK, PorterDuff.Mode.MULTIPLY));
    }

    private void attachBtToSpeaker(int size) {
        voIpButtonView.unSelectedIcon = new TLottieDrawable(R.raw.bt_to_speaker, "" + R.raw.bt_to_speaker, size, size, true, null);
        voIpButtonView.selectedIcon = new TLottieDrawable(R.raw.bt_to_speaker, "" + R.raw.bt_to_speaker, size, size, true, null);
        voIpButtonView.selectedIcon.setColorFilter(new PorterDuffColorFilter(Color.BLACK, PorterDuff.Mode.MULTIPLY));
    }
    ...
    public static class VoIpButtonView extends View {
        ...
        private TLottieDrawable unSelectedIcon;
        private TLottieDrawable selectedIcon;
        private TLottieDrawable singleIcon;
