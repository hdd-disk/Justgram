...
public class DrawerHeaderView extends FrameLayout {
    ...
    private final TLottieDrawable sunDrawable;
    private final FrameLayout themeToggleBg;
    private final TLottieImageView themeToggleView;
    ...
    public DrawerHeaderView(Context context) {
        ...
        backupImageView.setOnClickListener(this::onAvatarViewClick);
        ...
        int i = R.raw.sun;
        TLottieDrawable tLottieDrawable = new TLottieDrawable(i, String.valueOf(i), AndroidUtilities.dp(24.0f), AndroidUtilities.dp(24.0f), true, null);
        this.sunDrawable = tLottieDrawable;
        tLottieDrawable.setPlayInDirectionOfCustomEndFrame(true);
        TLottieImageView tLottieImageView = new TLottieImageView(context);
        this.themeToggleView = tLottieImageView;
        tLottieImageView.setAnimation(tLottieDrawable);
        ImageView.ScaleType scaleType = ImageView.ScaleType.CENTER;
        tLottieImageView.setScaleType(scaleType);
        frameLayout.addView(tLottieImageView, LayoutHelper.createFrame(24, 24, 17));
        setThemeToggleStaticState(Theme.isCurrentThemeDark());
        frameLayout.setOnClickListener(this::onThemeToggleClick);
        frameLayout.setOnLongClickListener(this::onThemeToggleLongClick);
        ...
        frameLayout2.setOnClickListener(this::onProxyButtonClick);
        ...
        animatedTextView.setVisibility(GONE);
        ...
        frameLayout3.setOnClickListener(this::onHeaderClick);
        ...
        simpleTextView.setRightDrawableOnClick(this::onStatusViewClick);
        simpleTextView.setRightDrawable2OnClick(this::onBadgeViewClick);
    ...
    private void onAvatarViewClick(View view) {
    ...
    private void onThemeToggleClick(View view) {
    ...
    private boolean onThemeToggleLongClick(View view) {
    ...
    private void onProxyButtonClick(View view) {
    ...
    private void onStatusViewClick(View view) {
    ...
    private void onBadgeViewClick(View view) {
    ...
    public TLottieImageView getThemeToggleView() {
    ...
    public void updateUserInfo(BadgeDTO badgeDTO) {
        ...
        this.avatarView.setRoundRadius(AndroidUtilities.dp(36.0f));
        ...
        String publicUsername = DialogObject.getPublicUsername((TLObject) (Object) currentUser);
    ...
    public void updateProxyStatus() {
        ...
        if (i > 0) {
            ...
            if (i == 2) {
                animatedTextView.setVisibility(VISIBLE);
    ...
    private void clearBadgeDrawables(boolean z) {
        ...
        this.exteraBadgeDrawable.setColor((Integer) null);
    }
    ...
    private void updateThemeToggleColors() {
        TLottieDrawable tLottieDrawable = this.sunDrawable;
        int i = COLOR_KEY_ICON;
        applyThemeToggleColors(tLottieDrawable, Theme.getColor(i));
        this.themeToggleView.setColorFilter(createColorFilter(i));
        this.themeToggleView.invalidate();
    }

    private void applyThemeToggleColors(TLottieDrawable tLottieDrawable, int i) {
        tLottieDrawable.setColorFilter(new PorterDuffColorFilter(i, PorterDuff.Mode.SRC_IN));
        tLottieDrawable.beginApplyLayerColors();
        tLottieDrawable.setLayerColor("Sunny.**", i);
        tLottieDrawable.setLayerColor("Path 6.**", i);
        tLottieDrawable.setLayerColor("Path.**", i);
        tLottieDrawable.setLayerColor("Path 5.**", i);
        tLottieDrawable.commitApplyLayerColors();
    }
